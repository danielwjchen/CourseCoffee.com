...
class QuestAPIController extends APIController implements ControllerInterface {
	...
	public static function Route() {
		return array(
			'issueQuestToken' => array(
				'quest-init',
			),
			'handleQuestCreation' => array(
				'quest-add',
			),
			'handleQuestCreationFromDoc' => array(
				'quest-add-from-doc',
			),
			'updateQuest' => array(
				'quest-update',
			...
			'getQuestDetail' => array(
				'quest-detail',
			),
			'updateQuestStatus' => array(
				'quest-status-update',
			),
			'getQuestBelongToUser' => array(
				'user-list-quest',
			),
			'getQuestBelongToClass' => array(
				'class-list-quest',
			),
			'getQuestBelongToDate' => array(
				'calendar-list-quest',
			),
		);
	}
