...
/**
 * @file
 * Handle user API related controller logics
 *
 * @author Daniel Chen <daniel@coursecoffee.com>
 */
class UserAPIController extends APIController implements ControllerInterface {
	...
	public static function Route() {
		return array(
			'registerUserByFB' => array(
			 	'user-register-facebook',
			),
			'registerUserByUs' => array(
				'user-register-regular',
			),
			'linkUserWithFacebook' => array(
				'user-link-facebook',
			),
			'updateUser' => array(
				'user-update',
