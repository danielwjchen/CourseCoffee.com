...
class CurriculumCalendarPageView extends PageView implements PageViewInterface {
	...
	function __construct($content = null) {
		...
		$this->addJS('Page/panel.js');
		$this->addJS('Curriculum/timer.js');
		$this->addJS('Curriculum/task.js');
		$this->addJS('Curriculum/calendar.js');
		$this->addJS('Curriculum/calendar-model.js');
		$this->addCSS('Page/modal.css');
		$this->addCSS('Page/panel.css');
		$this->addCSS('Curriculum/calendar.css');
		$this->addCSS('Curriculum/task.css');
		$this->addCSS('Item/item-list.css');
	}
