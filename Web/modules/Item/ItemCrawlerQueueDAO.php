...
/**
 * @file
 * Oversee access to item_Crawler_queue
 */
class ItemCrawlerQueueDAO extends DAO implements DAOInterface {
	...
	public function create($params) {
		return $this->db->insert("
			REPLACE INTO `item_crawler_queue`
	...
	public function destroy() {
		$sql = 'DELETE FROM `item_crawler_queue` WHERE ';
		$where_clause = array();
		$sql_params = array();
