...
class File {
	 ...
	 *   otherwise.
	 */
	function PrepareDirectory(&$directory, $options = self::MODIFY_PERMISSIONS) {
	 ...
	 */
	public function ScanDirectory($dir, $mask, $options = array(), $depth = 0) {
		// Merge in defaults.
		$options += array(
			'nomask' => '/(\.\.?|CVS)$/',
			'callback' => 0,
...
File::scanDirectory('sdf', 'asdfasdf');
