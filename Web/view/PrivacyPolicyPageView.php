 ...
 */
class PrivacyPolicyPageView extends PageView implements PageViewInterface {
		...
		<div class="tale body">
			<div class="body-inner">
				<div class="content">
					...
					<p>Thank you for visiting coursecoffee.com. This privacy policy tells you how we use personal information collected at this site. Please read this privacy policy before using the site or submitting any personal information. By using the site, you are accepting the practices described in this privacy policy. These practices may be changed, but any changes will be posted and changes will only apply to activities and information on a going forward, not retroactive basis. You are encouraged to review the privacy policy whenever you visit the site to make sure that you understand how any personal information you provide will be used.</p>
					...
					<p>If you have any questions, concerns, or comments about our privacy policy you may contact us at <a href="mailto:contact@coursecoffee.com">contact@coursecoffee.com</a></p>
