function slideShow() {
    ...
    $('#gallery .caption').css({width: $('#gallery
...
function gallery() {
    ...
    var current = ($('#gallery a.show')?  $('#gallery a.show') : $('#gallery
a:first'));
 
    //Get next image, if it reached the end of the slideshow, rotate it back to
the first image
...
$('#gallery a:first') :current.next()) : $('#gallery a:first'));   
    ...
    $('#gallery .caption').animate({opacity: 0.7},100 ).animate({height:
'100px'},500 );
