...
class ItemAttributeTypeDAOTestCase extends DAOTestCase implements DAOTestCaseInterface{
	...
	function testCreate() {
		...
		$new_record = $this->db->fetch(
			"SELECT * FROM `item_attribute_type` WHERE `name` = :name",
	...
	function testUpdate() {
		...
		$record = $this->db->fetch(
			'SELECT * FROM item_attribute_type WHERE id = :id', 
