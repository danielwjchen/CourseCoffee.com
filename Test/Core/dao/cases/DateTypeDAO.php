...
class DateTypeDAOTestCase extends DAOTestCase implements DAOTestInterface{
	...
	function __construct() {
		parent::__construct();
		require_once DAO_PATH .'DateTypeDAO.php';
	 ...
	 */
	function setUp() {
		DAOSetup::CleanUp('date_type');
		$stage = DAOSetup::Prepare('date_type');
