...
class QuestAttributeTypeDAOTestCase extends DAOTestCase implements DAOTestInterface{
	...
	function __construct() {
		parent::__construct();
		require_once DAO_PATH .'QuestAttributeTypeDAO.php';
	 ...
	 */
	function setUp() {
		DAOSetup::CleanUp('quest_attribute_type');
		$stage = DAOSetup::Prepare('quest_attribute_type');
